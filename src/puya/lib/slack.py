...
class SlackNotifier:
    ...
    def update_message_approved(self, message_ts: str, pending_id: int, approved_by: str) -> None:
    ...
    def update_message_rejected(self, message_ts: str, pending_id: int, rejected_by: str) -> None:
